...
export default function Page() {
  ...
  const handleCalBMIClick = () => { //Validate
    if(weight === "" || height === ""){
      alert("กรุณาป้อนค่าน้ำหนัก และส่วนสูงให้ครบถ้วน");
      return;
    }
    ...
    if(bmiValue < 18.5){
      ...
      setBmiCategory("น้ำหนักปกติ เหมาะสม");
    }else if(bmiValue < 29.9){
      setBmiCategory("อ้วน");
    }else if(bmiValue < 39.9){
      setBmiCategory("อ้วนมาก");
    }else{
      setBmiCategory("อ้วนอันตราย");
    }
